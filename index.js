...
//Це може залежити, як від вашої ОС так і версії Node, це не є критичним тому в тестах ви можете
// використовувати власні приклади.
...
function compareCharCodeAtAndCodePointAt(string, index) {
  ...
  // Використовуємо метод charCodeAt(), щоб отримати код символа з рядка на певній позиції, та запишемо результат 
  //в змінну charCodeAtResult
  // Використовуємо метод codePointAt(), щоб отримати код символа з рядка на певній позиції, та запишемо результат
  // в змінну codePointAtResult
...
// Завдання 12: Напишіть функцію, яка буде додавати символи до рядка з початку або з кінця, в залежності від значення 
//аргументу "side".
...
function padString(original, length, padWith, side) {
  ...
  // Використовуємо метод padStart(), щоб доповнити рядок string до певної довжини length, вставляючи символи padWith
  // на початку
...
// Завдання 14: Напишіть функцію, яка буде перетворювати рядок в верхній або нижній регістр, в залежності від значення
// аргументу "caseType".
